        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-100 p-6 rounded-md shadow-2xl">
            ...
            <ul className="text-[#333] mt-10 space-y-6">
              <li className="flex flex-wrap gap-4 text-base">Per person <span className="ml-auto font-bold">$50.00</span></li>
              <li className="flex flex-wrap gap-4 text-base">No of Person <span className="ml-auto font-bold">5</span></li>
              {/* <li className="flex flex-wrap gap-4 text-base">Total Amount <span className="ml-auto font-bold">$250.00</span></li> */}
