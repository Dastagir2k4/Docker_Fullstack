      ...
      <footer className="bg-gray-900 text-white pt-12 pb-8 px-4">
        <div className="mx-auto px-4 container overflow-hidden flex flex-col lg:flex-row justify-between">
          <a href="/" className="block mr-4 w-1/3">
            ...
            <h2 className='w- ml-2 lg:ml-0 h-46 text-4xl'>Reserve Eat</h2>
          </a>
          <div className="w-2/3 block sm:flex text-sm mt-6 lg:mt-0">
            ...
            <div className="text-gray-700 flex flex-col w-full">
              ...
              <div className="flex pl-4 justify-start mt-2">
                <a className="block flex items-center text-gray-300 hover:text-white mr-6 no-underline" href="#" target="_blank" rel="noopener noreferrer">
                ...
                <a className="block flex items-center text-gray-300 hover:text-white no-underline" href="#" target="_blank" rel="noopener noreferrer">
                  <svg viewBox="0 0 24 24" className="fill-current w-5 h-5" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="pt-4 mt-4 pt-6 text-gray-600 border-t border-gray-800 text-center">
          © 2023 ReserveEat. All rights reserved.
        </div>
      </footer>
    </div>
  );
